                    ...
                    <div class="form">
                        <div class="fields">
                            ...
                            <div class="SB-form-control">
                                <input bind:value={name} type="text" name="username" id="username" placeholder="USERNAME">
                            </div>
                        </div>
                        ...
                        <div class="fields">                        
                            ...
                            <div class="SB-form-control">
                                <input bind:value={country} type="text" name="country" id="country" placeholder="COUNTRY">
                            </div>
                        </div>
                        ...
                        <div class="fields">                        
                            ...
                            <div class="SB-form-control">
                                <input bind:value={phone} type="tel" name="phone" id="phone" placeholder="MOBILE NUMBER">
                            </div>
                        </div>
                        ...
                        <div class="fields">                        
                            ...
                            <div class="SB-form-control">
                                <input bind:value={confirmpass} type="password" name="passwordConfirm" id="confirmpass" placeholder="CONFIRM PASSWORD">
                            </div>
                        </div>
